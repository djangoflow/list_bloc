...
class PetApi {
  ...
  Future<Response<BuiltList<Pet>>> findPetByStatusList({ 
  ...
  Future<Response<BuiltList<Pet>>> findPetByTagList({ 
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ApiResponse>> imageCreate({ 
    required int petId,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> petCreate({ 
    required Pet body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> petUpdate({ 
    required Pet body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> petWithFormUpdate({ 
    required int petId,
    String? name,
    String? status,
    CancelToken? cancelToken,
