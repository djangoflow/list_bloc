...
class ContinuousListViewBlocBuilder<T, F extends OffsetLimitFilter> extends StatefulWidget {
  ...
  @override
  State<ContinuousListViewBlocBuilder<T, F>> createState() => _ContinuousListViewBlocBuilderState<T, F>();
}

class _ContinuousListViewBlocBuilderState<T, F extends OffsetLimitFilter> extends State<ContinuousListViewBlocBuilder<T,F>> {
