...
void main() {
  group('SliverSliverListBlocBuilder test', () {
    ...
    final widget = CustomScrollView(
      slivers: [
        SliverListBlocBuilder<ListCubit<String, TestFilter>, String, TestFilter>(
    ...
    testWidgets(
      'When Data is emitted, then widget from SliverListBlocBuilder.itemBuilder sould be displayed $itemCount times',
      (tester) async {
    ...
    testWidgets(
      'When Data.error is emitted, then widget from SliverListBlocBuilder.errorBuilder sould be displayed',
      (tester) async {
        cubit = MockListCubit<String, TestFilter>();
    ...
    testWidgets(
      'When Data.loading is emitted, then widget from SliverListBlocBuilder.loadingBuilder sould be displayed $itemCount times',
      (tester) async {
        cubit = MockListCubit<String, TestFilter>();
    ...
    testWidgets(
      'When Data.empty is emitted, then widget from SliverListBlocBuilder.emptyBuilder sould be displayed',
      (tester) async {
        cubit = MockListCubit<String, TestFilter>();
