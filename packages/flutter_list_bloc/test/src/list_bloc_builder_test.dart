...
void main() {
  group('ListBlocBuilder test', () {
    ...
    final widget = ListBlocBuilder<ListCubit<String, TestFilter>, String, TestFilter>(
      ...
      builder: (context, state, itemCount, itemBuilder) => TestBuilderContainer(
        child: ListView(
          children: [
