...
void main() {
  group('SliverListBlocBuilder', () {
    late ListCubit<Item, ItemType> listCubit;
    late SliverListBlocBuilder<ListCubit<Item, ItemType>, Item, ItemType>
        sliverListBlocBuilder;

    setUp(() {
      listCubit = ListCubit<Item, ItemType>(([ItemType? filter]) async => []);
      sliverListBlocBuilder =
          SliverListBlocBuilder<ListCubit<Item, ItemType>, Item, ItemType>(
        cubit: listCubit,
    ...
    group('Data State', () {
      testWidgets(
        'should dispay list items when data is available',
        (WidgetTester tester) async {
          listCubit.emit(
